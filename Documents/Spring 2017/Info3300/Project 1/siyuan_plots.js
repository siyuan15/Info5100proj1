...
// draw axis on svg
var squarePlot = svgPerHour.append("g").attr("transform", "translate(0,0)");
squarePlot.append("g").call(hourAxis).attr("transform", "translate(0,350)");
squarePlot.append("g").call(weekAxis).attr("transform", "translate(0,0)");
